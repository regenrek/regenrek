...
|---|---|---|
| [oplink](https://github.com/regenrek/oplink) <sup>NEW</sup> | easy workflows for mcp tools | 0 |
...
| Name | Description | Stars |
|---|---|---|
| [codex-1up](https://github.com/regenrek/codex-1up) | 🍄 Give your CLI an extra life | 234 |
| [slash-commands](https://github.com/regenrek/slash-commands) | A collection of slash commands | 68 |
